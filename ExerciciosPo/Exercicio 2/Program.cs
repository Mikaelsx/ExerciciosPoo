...
MaquinaCafe v3 = new MaquinaCafe();

MaquinaCafe.gramas = 40;

Console.Clear();

Console.WriteLine($"Qual o sabor do seu café ?");
v3.sabor = Console.ReadLine()!;

Console.WriteLine($"Quantas gramas de açucar voçê deseja ?");
v3.gramas = float.Parse(Console.ReadLine()!);
